...
export async function GET(
  ...
  try {
    ...
    const logos = {
      ...
      organization: {
        logoS3Key: report.facility.clientOrganization.logoS3Key,
        logoFileType: report.facility.clientOrganization.logoFileType,
      },
    };
    ...
    const pdf = await exportPdf(payload, logos);
